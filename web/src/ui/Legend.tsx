...
export function Legend({ scale, walls }: { scale: Scale; walls?: Walls }) {
  ...
  return (
    <div className="absolute bottom-3 left-3 max-h-[40%] w-56 overflow-y-auto rounded-lg border border-neutral-700 bg-neutral-900/90 p-3 text-neutral-100 backdrop-blur">
      <p className="mb-1 text-xs font-medium text-neutral-300">{TITLE[scale.mode]}</p>
